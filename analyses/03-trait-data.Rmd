...
AsherTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Asher.csv")
...
DennisTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Dennis.csv")
...
EelesTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Eeles.csv")
...
EmmetTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Emmet.csv")
...
NewlandTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Newland.csv")
...
ThomasTraits <- read.csv("../leps/data/traitData/Middleton_Welling2017_Thomas.csv")
...
rawTraits <- read.csv("../leps/data/traitData/Isaac_Dennis_traits/speciestraits208.csv")

require(tidyverse)
traits2 <- rawTraits %>% select(scientificname, 
                   NEsp, # Nectar specialisation
                   Fsp, # Adult feeding specialisation
                   ProboscisL, # Proboscis length
                   RPL, # Relative proboscis length
                   EggSize, # Egg size
                   RES, # Relative egg size
                   Symbiosis, # Symbiosis in early stadia
                   HibStage, # Hibernation stage (1 to 4, 2.5 for P. aegeria)
