...
>Jönsson, G. M. (2020). A century of functional diversity and functional trait composition trends among British Lepioptera.  Unpublished manucript. 


## Data
### Species occurence data
I used two sources of species occurence data: specimen records from the Natural History Museum, London (NHM), and observational records from Butterfly Conservation. The Butterfly Conservation data is available upon request from: 
...
UK
Email: brc@ceh.ac.uk
Telephone: +44 (0) 1491 692 357

The georeferenced NHM dataset is available via the [NHM iCollections](https://data.nhm.ac.uk/dataset/collection-specimens/resource/05ff2255-c38a-40c9-b657-4ccb55ab2feb?filters=project%3AiCollections). If you use it, please cite as folows: 
...
### Species trait data
I used multiple sources of species trait data:
**FILL IN**
...
* __01-cleanBCdata.Rdm__ cleans and standardises the Butterfly conservation data. (See 01-DataWrangling.Rdm in my [Collector-Behaviour github repo]("https://github.com/galinajonsson/collector-behaviour") for the code used to clean and standardise the NHM data. 
* __02-format-data.Rdm__ formats the clean data to run occupancy models. See `cluster-codeMarch.R` for the code used to run the models. 
* __03-OccupancyTrends.Rmd__ summarises occupancy model outputs.
* __04-TraitData.Rmd__ cleans and standardises the trait data.
* __05-TraitDiversity.Rmd__ runs the functional diversity metrics and functional trait compositin metrics.

##### Code for figures
* __function-plot.occDet_G.R__


##### Code for functions
* __function-extractPosterior.R__
* __function-summarise_CWM.R__
* __function-summarise_FDmatrics.R__
